...
describe('Service Tests', () => {
  describe('DetalleEvento Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a DetalleEvento', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            horaIngreso: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should update a DetalleEvento', async () => {
        const returnedFromService = Object.assign(
          {
            horaIngreso: currentDate.format(DATE_TIME_FORMAT),
            horaEngreso: currentDate.format(DATE_TIME_FORMAT)
      ...
      it('should return a list of DetalleEvento', async () => {
        const returnedFromService = Object.assign(
          {
            horaIngreso: currentDate.format(DATE_TIME_FORMAT),
            horaEngreso: currentDate.format(DATE_TIME_FORMAT)
      ...
      it('should delete a DetalleEvento', async () => {
