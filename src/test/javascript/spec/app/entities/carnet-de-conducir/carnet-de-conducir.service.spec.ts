...
describe('Service Tests', () => {
  describe('CarnetDeConducir Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a CarnetDeConducir', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            fechaOtorgamiento: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should update a CarnetDeConducir', async () => {
        const returnedFromService = Object.assign(
          {
            categoria: 'BBBBBB',
            fechaOtorgamiento: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should return a list of CarnetDeConducir', async () => {
        const returnedFromService = Object.assign(
          {
            categoria: 'BBBBBB',
            fechaOtorgamiento: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should delete a CarnetDeConducir', async () => {
