...
describe('Service Tests', () => {
  describe('EspacioComun Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a EspacioComun', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            disponibilidadDesde: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should update a EspacioComun', async () => {
        const returnedFromService = Object.assign(
          {
      ...
      it('should return a list of EspacioComun', async () => {
        const returnedFromService = Object.assign(
          {
            nombreEspacioComun: 'BBBBBB',
            disponibilidadDesde: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should delete a EspacioComun', async () => {
