...
describe('Service Tests', () => {
  describe('PlanillaIngresoEgreso Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a PlanillaIngresoEgreso', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            fechaIngreso: currentDate.format(DATE_TIME_FORMAT),
      ...
      it('should update a PlanillaIngresoEgreso', async () => {
        const returnedFromService = Object.assign(
          {
      ...
      it('should return a list of PlanillaIngresoEgreso', async () => {
        const returnedFromService = Object.assign(
          {
            autorizadoPrevio: true,
            acompaniantes: 1,
      ...
      it('should delete a PlanillaIngresoEgreso', async () => {
